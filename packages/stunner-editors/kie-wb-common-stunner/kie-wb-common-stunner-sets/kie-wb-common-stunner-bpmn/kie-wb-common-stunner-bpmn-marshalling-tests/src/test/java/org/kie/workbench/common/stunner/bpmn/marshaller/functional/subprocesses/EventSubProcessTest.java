...
package org.kie.workbench.common.stunner.bpmn.marshaller.functional.subprocesses;
...
public class EventSubProcessTest extends SubProcessTest<EventSubprocess> {
    ...
    private void assertEventSubProcessExecutionSet(BaseSubprocessTaskExecutionSet executionSet,
                                                   boolean isAsync,
                                                   String slaDueDate) {
