...
package org.kie.workbench.common.stunner.bpmn.marshaller.functional.events;
...
public abstract class StartEventTest<T extends StartEvent> extends BPMNDiagramMarshallerBaseTest {
    ...
    protected void assertStartEventSlaDueDate(BaseStartEventExecutionSet executionSet, String slaDueDate) {
        ...
        assertEquals(slaDueDate, executionSet.getSlaDueDate());
    }
    ...
    protected void assertStartEventIsInterrupting(BaseStartEventExecutionSet executionSet, boolean isInterrupting) {
        ...
        assertEquals(isInterrupting, executionSet.getIsInterrupting());
    }
}
