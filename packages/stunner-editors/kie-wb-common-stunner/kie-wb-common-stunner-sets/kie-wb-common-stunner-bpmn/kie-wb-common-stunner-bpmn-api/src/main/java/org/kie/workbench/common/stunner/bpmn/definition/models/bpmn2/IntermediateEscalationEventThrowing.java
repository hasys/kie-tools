...
public class IntermediateEscalationEventThrowing extends BaseThrowingIntermediateEvent implements hasEscalationEventDefinition {
    ...
    public IntermediateEscalationEventThrowing(final @MapsTo("name") String name,
