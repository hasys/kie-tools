...
public interface hasErrorEvent {

    InterruptingErrorEventExecutionSet getExecutionSet();
    ...
    default ErrorEventDefinition getErrorEventDefinition() {
        return new ErrorEventDefinition(getExecutionSet().getErrorRef().getValue(), getErrorId());
    }
}
